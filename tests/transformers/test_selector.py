...
from k_onda.transformers import Slicer
...
def _make_window(t0_s, t1_s):
    return Slicer(
        selection_bounds={"time": [t0_s * ureg.s, t1_s * ureg.s]},
...
class TestGetPointsInterval:
    ...
    def test_interior_spikes_selected(self, spike_dataset, coord_map):
        ...
        point_dim, selected = win.get_point_indices(spike_dataset, coord_map, {"time"})
    ...
    def test_spike_at_lower_bound_is_included(self, spike_dataset, coord_map):
        ...
        _, selected = win.get_point_indices(spike_dataset, coord_map, {"time"})
    ...
    def test_no_map_dims_returns_all_indices(self, spike_dataset, coord_map):
        ...
        _, selected = win.get_point_indices(spike_dataset, coord_map, set())
...
class TestGetPointsOnTwoCoordMap:
    ...
    def test_interior_postitions_selected(self, position_dataset, two_coord_map):
        ...
        point_dim, selected = win.get_point_indices(position_dataset, two_coord_map, {"x", "y"})
