...
from .sources import DataSource, DataComponent, DataIdentity
...
class Neuron(DataIdentity):
    ...
    def __init__(self, data_components, neuron_type=None):
        ...
        self.subject.data_identities['neurons'].append(self)


class SpikeCluster(DataComponent, SignalCalculatorMixin, SelectMixin):
    ...
    def data_loader(self):
        ...
        waveforms = xr.DataArray(
            waveforms,
            dims=('spikes', 'samples', 'electrodes')
            )
