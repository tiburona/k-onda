...
PROPORTION_OPTS = {'kind_of_data': 'spike', 'data_type': 'proportion', 'pre_event': 0.05, 'post_event': 0.65,
                   'bin_size': 0.01, 'trials': (0, 150), 'adjustment': 'normalized', 'base': 'trial',
                   'time': 'continuous', 'row_type': 'trial'}

AUTOCORR_OPTS = {'kind_of_data': 'spike', 'data_type': 'autocorr', 'pre_event': 0.0, 'post_event': 30.0, 'bin_size': 0.01,
                 'tone_events': (0, 300, 30), 'pretone_events': (0, 300, 30), 'max_lag': 99, 'block_types': ['tone']}

SPECTRUM_OPTS = {'kind_of_data': 'spike', 'data_type': 'spectrum', 'pre_event': 0.0, 'post_event': 30.0, 'bin_size': 0.01,
...
SPREADSHEET_OPTS = {'kind_of_data': 'spike', 'data_path': '/Users/katie/likhtik/data', 'data_type': 'psth', 'base': 'trial',
                    'pre_event': 0.0, 'post_event': .05, 'adjustment': 'none', 'bin_size': 0.01, 'trials': (0, 150),
...
HEAT_MAP_DATA_OPTS = {'kind_of_data': 'lfp', 'data_path': '/Users/katie/likhtik/data', 'time_type': 'period',
                      ...
                      'row_type': 'frequency_bin', 'pre_event': 0, 'post_event': 0.3,
...
CAROLINA_OPTS = {'kind_of_data': 'spike', 'data_path': '/Users/katie/likhtik/CH_for_katie_less_conservative',
                 'data_type': 'psth', 'base': 'trial', 'pre_event': .05, 'post_event': .65, 'adjustment': 'normalized',
...
CAROLINA_GROUP_STAT_OPTS = {'kind_of_data': 'spike', 'data_type': 'psth', 'adjustment': 'normalized',
                            'time_type': 'continuous', 'pre_event': 0.0, 'post_event': 0.70, 'bin_size': 0.01,
...
CROSS_CORR_OPTS = {'kind_of_data': 'spike', 'data_type': 'correlogram', 'pre_event': 0, 'post_event': 1,
...
CAROLINA_MRL_OPTS = {'kind_of_data': 'lfp', 'data_type': 'mrl', 'bin_size': 0.01, 'pre_event': 0, 'post_event': .3,
...
LFP_OPTS = {'kind_of_data': 'lfp', 'time_type': 'block', 'frequency_bands': ['theta_1', 'theta_2'], 'data_type': 'power',
            ...
            'events': {'pretone': {'pre_event': 0, 'post_event': 1}, 'tone': {'pre_event': 0, 'post_event': .3}},
...
POWER_SPREADSHEET_OPTS = {
    ...
    'blocks': {'tone': range(5), 'pretone': range(5)}, 'power_deviation': False, 'collapse_sem_data': True,
    'events': {'pretone': {'pre_event': .05, 'post_event': .3}, 'tone': {'pre_event': .05, 'post_event': .3}},
    'rules': {'brain_region': {'pl': [('selected_animals', PFC_THETA_POWER_ANIMALS)],
                               'bla': [('selected_animals', BLA_THETA_POWER_ANIMALS)],
                               'hpc': [('selected_animals', HPC_THETA_POWER_ANIMALS)]}},
    'matlab_configuration': MATLAB_CONFIG
...
SPECTROGRAM_OPTS = {
    ...
    'events': {
        'pretone': {'pre_event': .15, 'post_event': .3}, 'tone': {'pre_event': .15, 'post_event': .3}
        },
    'rules': {
        'brain_region': 
...
POWER_OPTS = {
    ...
    'events': {
        'pretone': {'pre_event': .15, 'post_event': .85}, 'tone': {'pre_event': .85, 'post_event': .3}
        },
    'rules': {
        'brain_region': 
        {'pl': [('filter', {'animal': {'identifier': ('in', PFC_THETA_POWER_ANIMALS)}})],
...
PROPORTION_OPTS = {
    ...
    'events': {'pretone': {'pre_event': 0.05, 'post_event': .65}, 'tone': {'pre_event': .05, 'post_event': .65}},
    }

PSTH_OPTS = {'kind_of_data': 'spike', 'calc_type': 'firing_rates', 'bin_size': 0.01,
             'average_method': 'mean', 'time_type': 'continuous', 
             'periods': {'pretone': range(5), 'tone': range(5)}, 'base': 'event'}
...
GROUP_STAT_PROPORTION_OPTS = {
    ...
    'events': {
        'pretone': {'pre_event': 0.0, 'post_event': .7}, 'tone': {'pre_event': .0, 'post_event': .7}
...
GROUP_STAT_PSTH_OPTS = {'kind_of_data': 'spike', 'data_type': 'psth', 'adjustment': 'normalized', 'time_type': 'continuous', 
                        ...
                        'events': {'pretone': {'pre_event': 0.0, 'post_event': .7}, 'tone': {'pre_event': .0, 'post_event': .7}}, 
...
# PSTH_OPTS = {'kind_of_data': 'spike', 'calc_type': 'psth', 'bin_size': 0.01, 'adjustment': 'normalized',
            ...
            #             'animal': {'identifier': ('in', STANDARD_ANIMALS)}},
            #  'events': {'pretone': {'pre_event': 0.05, 'post_event': .65}, 'tone': {'pre_event': 0.05, 'post_event': .65}}}
...
COUNT_OPTS = {'kind_of_data': 'spike', 'data_type': 'spike_counts', 'bin_size': 0.01, 'adjustment': 'none',
            'time_type': 'continuous', 'row_type': 'event', 
             ...
             'inclusion_rule': {'unit': [['quality', 'in', NEURON_QUALITY]], 
                                'animal': [['identifier', 'in', STANDARD_ANIMALS]]},
             'events': {'pretone': {'pre_event': .0, 'post_event': .3}, 'tone': {'pre_event': .0, 'post_event': .3}}}
...
PHASE_PHASE_OPTS = {
    ...
    'events': {'pretone': {'post_event': .3}, 'tone': {'post_event': .3}},
...
GRANGER_OPTS = {
    ...
    'events': {'pretone': {'post_event': 1}, 'tone': {'post_event': 1}},
...
AS_COHERENCE_CALC_OPTS = {
    'kind_of_data': 'lfp', 'calc_type': 'coherence', 
    'frequency_bands': [ 'theta_1', 'theta_2'], 
    'region_sets': ['pl_bla', 'bla_vhip', 'pl_vhip'], 
    'base': 'coherence_calculator',
    ...
    'section': {
        ...
        'label': {
            'y': {
                ...
                'space_within': 0.1}, 
            'title': {
                'text': '{region_set} {frequency_band} Coherence',
                'space_between': .1,
                'x': .60},
            },
        'segment': {
            ...
            'label': {
                       'x_ax': 
                       {'text': '{conditions|treatment}', 'which': 'absolute_last'},
                       'y_ax': {'text': '{conditions|sex}', 'which': 'absolute_first'}
                        },
